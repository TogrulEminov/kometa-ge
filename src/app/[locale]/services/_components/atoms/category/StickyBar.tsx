  ...
  return (
    <div className="lg:sticky lg:top-25 space-y-6">
          ...
          {services.map((service) => {
            ...
            return (
              <div key={service.id}>
                ...
                {service.subServices && isExpanded && (
      ...
      <div className="bg-linear-to-br from-primary to-[#8a0d1e] rounded-2xl p-6 shadow-xl relative overflow-hidden">
        ...
        <button className="w-full bg-foreground text-primary font-bold py-3 px-4 rounded-xl hover:bg-foreground/90 transition-colors duration-300 flex items-center justify-center gap-2 relative z-10">
