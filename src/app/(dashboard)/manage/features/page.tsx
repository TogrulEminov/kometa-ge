...
import { features_list } from "../../_type/query-key";
...
import { getFeaturesInfo } from "@/actions/client/features/features.controller";
      ...
      <QueryTabs defaultTab="info" queryParam="type">
        ...
        <div>
          <TabsBody value="info">
            ...
            <Content
              existingData={existingData as FeaturesType}
              refetch={refetch}
            />
          </TabsBody>
