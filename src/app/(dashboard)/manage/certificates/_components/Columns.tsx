...
export const Columns: AdminTableColumn<CertificatesType>[] = [
  {
    title: "Title",
    key: "title",
    width: 250,
  ...
  },
  {
    ...
    render: (_, record) => (
      <Link
        href={pageRoutes.certificates.updateImage({ id: record.id })}
  ...
  },
  {
    ...
    render: (_, record) => (
      <Link
        href={pageRoutes.certificates.updateGallery({ id: record.id })}
        className="text-sm mx-auto  w-fit text-blue-600 hover:underline"
      >
        <TfiGallery size={26} />
      </Link>
