...
export const Columns: AdminTableColumn<PhotoGalleryType>[] = [
  {
    title: "Title",
    key: "title",
    width: 250,
  ...
  },
  {
    ...
    render: (_, record) => (
      <Link
        href={pageRoutes.photoGallery.updateImage({ id: record.id })}
  ...
  },
  {
    ...
    render: (_, record) => (
      <Link
        href={pageRoutes.photoGallery.updateGallery({ id: record.id })}
        className="text-sm mx-auto  w-fit text-blue-600 hover:underline"
      >
        <TfiGallery size={26} />
      </Link>
