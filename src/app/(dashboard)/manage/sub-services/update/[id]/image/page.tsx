...
import { getServicesById } from "@/actions/client/services/services.controller";
import { sub_services_list } from "@/app/(dashboard)/_type/query-key";
import { getSubServicesById, uptadeSubServicesImage } from "@/actions/client/services-sub/services-sub.controller";
...
export default function UpdateImagePage() {
  ...
  const { execute, isExecuting } = useAction(uptadeSubServicesImage, {
